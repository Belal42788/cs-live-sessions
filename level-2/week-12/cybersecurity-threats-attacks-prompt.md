...
Present the 6-event, 3-week timeline exactly as in the source (each event its own card, in chronological order), student thinks through which Attack Lifecycle stage each belongs to. Events:
